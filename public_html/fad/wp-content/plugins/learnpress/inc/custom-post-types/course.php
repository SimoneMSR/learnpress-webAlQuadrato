				...
				'fields'   => array(
					array(
						...
						'options' => array(
							...
							'evaluate_lessons_and_quizzes' => __( 'Evaluate lessons and quizzes', 'learnpress' ) . sprintf( '<p class="description option-desc">%s</p>', __( 'Evaluate by lessons and quizzes user has completed per total lessons and quizzes.', 'learnpress' ) )
						),
						'std'     => 'evaluate_lesson',
						'inline'  => false
					),
					array(
						...
						'min'  => 1,
						'max'  => 100,
						'desc' => __( 'The percentage of quiz result and/or lessons completed to finish the course.', 'learnpress' ),
						'std'  => 80,
					)
				)
			);
