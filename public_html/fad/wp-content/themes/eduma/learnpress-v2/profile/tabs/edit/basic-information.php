...
<ul class="lp-form-field-wrap">
  ...
  <li class="lp-form-field">
      <label class="lp-form-field-label"><?php _e( 'Luogo di nascita', 'learnpress' ); ?></label>
      <div class="lp-form-field-input">
          <input type="text" name="lp_info[birth_place]" id="birth_place"
                 value="<?php echo isset( $lp_info['birth_place'] ) ? $lp_info['birth_place'] : ''; ?>"
                 class="regular-text"/>
      </div>
  </li>
  <li class="lp-form-field">
      <label class="lp-form-field-label"><?php _e( 'Data di nascita', 'learnpress' ); ?></label>
      <div class="lp-form-field-input">
          <input type="text" name="lp_info[birth_date]" id="birth_date"
                 value="<?php echo isset( $lp_info['birth_date'] ) ? $lp_info['birth_date'] : ''; ?>"
                 class="date-picker"/>
      </div>
  </li>
  <li class="lp-form-field">
      <label class="lp-form-field-label"><?php _e( 'Codice fiscale', 'learnpress' ); ?></label>
      <div class="lp-form-field-input">
          <input type="text" name="lp_info[fiscal_code]" id="fiscal_code"
                 value="<?php echo isset( $lp_info['fiscal_code'] ) ? $lp_info['fiscal_code'] : ''; ?>"
                 class="regular-text"/>
      </div>
  </li>
  <li class="lp-form-field">
